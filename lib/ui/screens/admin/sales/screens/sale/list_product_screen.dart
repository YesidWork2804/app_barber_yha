...
import 'package:app_barber_yha/infrasctructure/products/product_repositorie.dart';
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(
                    ...
                    child: FutureBuilder(
                      future: Future.value(
                        providersSales.getProductosDisponibles(),
                      ),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                            ConnectionState.waiting) {
                          ...
                          final allProducts = snapshot.data!;
                          // providersSales.performSearchProducts(allProducts);
                          return Consumer<ProvidersSales>(
                            builder: (context, providersSales, child) {
                              return ListView.builder(
                                shrinkWrap: true,
